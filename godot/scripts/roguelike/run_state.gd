...
func _divine_face_value(symbol_id: String) -> int:
	match symbol_id:
		...
		"fate": return 107
		"death": return 108
		# 보스 신성 심볼은 기존 101~108 특수 심볼과 충돌하지 않도록 201~208을 사용합니다.
		"flame": return 201
		"frost": return 202
		"plague": return 203
		"blood": return 204
...
func get_run_summary() -> Dictionary:
	...
	return {"run_number": run_number, "gold": gold, "current_hp": current_hp, "max_hp": max_hp, "selected_build_id": selected_build_id, "dice_count": dice_count, "divine_count": divine_count, "boss_id": current_boss_id, "boss_cleared": boss_cleared}

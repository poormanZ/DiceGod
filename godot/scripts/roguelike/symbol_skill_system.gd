...
const SKILLS: Array[Dictionary] = [
	...
	{"id": "bow_pierce", "name": "관통 사격", "requires": {2: 2}, "penetration": 2, "description": "활 2개 이상이면 관통 +2"},
	{"id": "staff_burn", "name": "화염 주문", "requires": {3: 2}, "status": 2, "description": "지팡이 2개 이상이면 화상 강화"},
...
static func evaluate(results: Array[DiceRuntimeState]) -> Dictionary:
	...
	var total: Dictionary = {"attack": 0, "block": 0, "heal": 0, "penetration": 0, "hits": 0, "status": 0, "skills": []}
	for skill in SKILLS:
